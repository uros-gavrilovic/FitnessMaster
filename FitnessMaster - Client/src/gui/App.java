...
public class App extends javax.swing.JFrame {
    ...
    public App(Trainer user, Socket socket) {
        this.user = user;
        this.socket = socket;
    ...
    private void initComponents() {
        ...
        tbtnTrainers = new javax.swing.JToggleButton();
        ...
        tbtnTrainers.setBackground(Painter.GREEN);
        tbtnTrainers.setFont(new java.awt.Font("Segoe UI", 1, 18)); // NOI18N
        tbtnTrainers.setForeground(new java.awt.Color(255, 255, 255));
        tbtnTrainers.setIcon(new ImageResizer().resize(new javax.swing.ImageIcon(getClass().getResource("/gui/lib/img/trainer.png")), 50, 50));
        tbtnTrainers.setText("TRAINERS");
        tbtnTrainers.setBorderPainted(false);
        tbtnTrainers.setContentAreaFilled(false);
        tbtnTrainers.setEnabled(false);
        tbtnTrainers.setFocusable(false);
        tbtnTrainers.addChangeListener(new javax.swing.event.ChangeListener() {
            public void stateChanged(javax.swing.event.ChangeEvent evt) {
                tbtnTrainersStateChanged(evt);
            }
        });
        tbtnTrainers.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                tbtnTrainersActionPerformed(evt);
            }
        });
        pnlWest.add(tbtnTrainers);
    ...
    private void tbtnTrainersStateChanged(javax.swing.event.ChangeEvent evt) {//GEN-FIRST:event_tbtnTrainersStateChanged
        //setUpToggleButton((JToggleButton) evt.getSource());
    }//GEN-LAST:event_tbtnTrainersStateChanged
    ...
    private void tbtnTrainersActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_tbtnTrainersActionPerformed
        //openPanel(new TrainersPanel(user, socket));
    }//GEN-LAST:event_tbtnTrainersActionPerformed
    ...
    private javax.swing.JToggleButton tbtnTrainers;
